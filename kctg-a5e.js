...
Hooks.once('init', () => {
    game.settings.register('kctg-a5e', 'show-warning', {
        name: 'Thank you!',
...
function setting(key) {
    return game.settings.get('kctg-a5e', key);
}
...
Hooks.on("renderSettingsConfig", (app, html, data) => {
    ...
    warningParagraph.insertBefore($('[name="kctg-a5e.show-warning"]').parents('div.form-group:first'));
});
